...
Namespace newdatasetTableAdapters
    ...
    Partial Public Class TableTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([Id], [password]) VALUES (@Id, @password);"&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Id, "& _ 
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Table] SET [Id] = @Id, [password] = @password WHERE (([Id] = @Origi"& _ 
                "nal_Id) AND ([password] = @Original_password));"&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Id, password FROM [Table]"& _ 
                " WHERE (Id = @Id)"
